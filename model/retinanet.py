...
from .backbone_utils import resnet50_fpn_backbone, _validate_trainable_layers
from .feature_pyramid_network import LastLevelP6P7
from .focal_loss import sigmoid_focal_loss
from .boxes import box_iou, clip_boxes_to_image, batched_nms
from .utils import Matcher, overwrite_eps, BoxCoder
...
def retinanet_resnet50_fpn(pretrained=False, progress=True,
    ...
    backbone = resnet50_fpn_backbone(pretrained_backbone, returned_layers=[2, 3, 4],
